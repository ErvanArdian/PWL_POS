...
Route::group(['prefix' => 'user'], function() {
    ...
    Route::put('/{id}/update_ajax', [UserController::class, 'update_ajax']); //menimpan perubahan data user ajax
    Route::get('/{id}/delete_ajax', [UserController::class, 'confirm_ajax']); //untuk tampilkan form conform delete user ajax
...
Route::group(['prefix' => 'barang'], function() {
    ...
    Route::post('/list', [BarangController::class, 'list']);      //menampilkan data barang dalam bentuk json untuk databales
...
Route::group(['prefix' => 'level'], function() {
    Route::get('/', [LevelController::class, 'index']);          // menampilkan halaman awal untuk level
